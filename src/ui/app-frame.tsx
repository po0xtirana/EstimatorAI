...
const navGroups = [
  { label: "Work queue", items: [{ label: "Bid cockpit", href: "/" }, { label: "Opportunities", href: "/tenders" }, { label: "Estimates", href: "/estimates" }] },
  { label: "Company model", items: [{ label: "Operating model", href: "/trade-profiles" }, { label: "People & capacity", href: "/team" }] },
  { label: "Performance", items: [{ label: "Jobs & learning", href: "/jobs" }, { label: "Reports", href: "/reports" }] }
];
