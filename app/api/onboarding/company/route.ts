...
type StaffInput = { roleKey: string; roleNameEn: string; skillSummary: string; availableHeadcount: number; hourlyCostCents: number };
...
export async function GET() {
  try {
    ...
    const [organization, profile, trades, certifications, regions, version] = await Promise.all([
