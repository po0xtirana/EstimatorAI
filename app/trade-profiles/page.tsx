...
export default function TradeProfilesPage() {
  ...
  return <main className="profile-page">
    <div className="profile-header"><div><p className="eyebrow accent">Company operating model</p><h1>Teach EstimatorAI how your teams deliver.</h1><p className="profile-copy">Set up one operating profile per trade. The estimator uses these crews, rates, materials, equipment, and production templates to create project hours and costs automatically.</p></div></div>
